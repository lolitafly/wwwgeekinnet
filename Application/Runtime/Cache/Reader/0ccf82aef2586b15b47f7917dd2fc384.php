	...
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">朗读内容列表 </h3>
			</div>
			<ul class="list-group">
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/reader.php/Index/bookdetail/bid/<?php echo ($vo["bid"]); ?>" class="list-group-item">
					<div class="row">
						<div class="col-xs-5">
							《<?php echo ($vo["title"]); ?>》
						</div>
						<div class="col-xs-5">
							发起人:<?php echo ($vo["nickname"]); ?>
						</div>
						<div class="col-xs-2">
							<span class="glyphicon glyphicon glyphicon-chevron-right pull-right" aria-hidden="true">
						</div>
