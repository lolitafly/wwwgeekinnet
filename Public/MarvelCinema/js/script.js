...
var jumpTimer;
var loading_flag=1;
var loadingStr=["排名查询中","排名查询中.","排名查询中..","排名查询中...",];
...
$(document).ready(function() {
	...
	setInterval(function(){
		$("#loading").text(loadingStr[loading_flag%4]);
		loading_flag++;
	}, 500);
...
function loadImg() {
	for (var i = 1; i <= imageTypeNum; i++) {
		var temp = "<img src=\"/Public/MarvelCinema/images/" + i + ".png\" />";
...
function setTime(t){
	...
	for(var i=0;i<temp.length;i++){
		html+="<img src=\"/Public/MarvelCinema/images/number/"+temp.charAt(i)+".png\" />";
	}
	$("#timer").html(html);
}
